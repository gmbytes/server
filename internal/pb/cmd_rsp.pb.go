...
// 心跳(客户端切换后台发送该消息)
type RspPingZZZ struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *RspPingZZZ) Reset() {
	*x = RspPingZZZ{}
...
func (x *RspPingZZZ) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RspPingZZZ) ProtoMessage() {}

func (x *RspPingZZZ) ProtoReflect() protoreflect.Message {
	mi := &file_cmd_rsp_proto_msgTypes[4]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RspPingZZZ.ProtoReflect.Descriptor instead.
func (*RspPingZZZ) Descriptor() ([]byte, []int) {
...
var file_cmd_rsp_proto_goTypes = []any{
	...
	(*RspPingZZZ)(nil),      // 4: pb.RspPingZZZ
